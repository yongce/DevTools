...
class BroadcastTesterActivity : GridEntriesActivity() {
    ...
    override val intents: List<IntentEntry>
        get() {
            val broadcasts: MutableList<IntentEntry> = ArrayList()
    ...
    private fun testBroadcastWithPerm(itemsList: MutableList<IntentEntry>) {
        val intent = Intent(AppConstants.ACTION_DYNAMIC_BROADCAST_TEST)
        val item = IntentEntry(
    ...
    private fun testBroadcastWithoutPerm(itemsList: MutableList<IntentEntry>) {
        val intent = Intent(AppConstants.ACTION_DYNAMIC_BROADCAST_TEST)
        val item = IntentEntry(
    ...
    private fun testPackageAdd(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testPackageReplaced(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    private fun testPackageRemoved(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    private fun testPackageChanged(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    @Suppress("DEPRECATION")
    private fun testNewOutgoingCall(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    private fun testSmsReceived(itemsList: MutableList<IntentEntry>) {
    ...
    @TargetApi(VERSION_CODES.KITKAT)
    private fun testSmsDeliver(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testConnectivityChange(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testWifiStateChange(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testBootComplete(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    private fun testShutdown(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    private fun testTimeSet(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testAppWidgetUpdate(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testBluetoothStateChange(itemsList: MutableList<IntentEntry>) {
        // SecurityException: protected-broadcast
    ...
    private fun testAirplaceModeChange(itemsList: MutableList<IntentEntry>) {
    ...
    private fun testLocationChanged(itemsList: MutableList<IntentEntry>) {
        // a) OK: no protection (older versions than android-4.4_r0.7)
        // b) SecurityException: protected-broadcast (android-4.4_r0.7+)
